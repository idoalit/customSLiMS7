...
if ($counter === true) {
  echo '<div class="alert alert-success">'.__($member_name.' thank you for inserting your data to our visitor log').'</div><span id="memberImage" src="images/persons/'.urlencode($photo).'"></span>';
  if ($expire) {
