...
<div class="menuBoxInner syslogIcon">
    ...
    <?php } ?>
    <form role="form" name="search" action="<?php echo MWB; ?>system/sys_log.php" id="search" method="get" style="display: inline;"><?php echo __('Search'); ?> :
    <input type="text" name="keywords" size="30" />
    <input type="submit" id="doSearch" value="<?php echo __('Search'); ?>" class="btn btn-default" />
    </form>
    <!-- LOG CLEARANCE FORM -->
    <?php if ($_SESSION['uid'] == 1) { ?>
    <form role="form" action="<?php echo MWB; ?>system/sys_log.php" id="clearLogsForm" target="blindSubmit" method="post" style="display: inline;"><input type="hidden" name="clearLogs" value="true" /></form>
    <form role="form" action="<?php echo MWB; ?>system/sys_log.php" id="saveLogsForm" target="blindSubmit" method="post" style="display: inline;"><input type="hidden" name="saveLogs" value="true" /></form>
    <?php } ?>
