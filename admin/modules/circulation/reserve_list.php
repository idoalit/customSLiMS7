...
<div style="padding: 5px; background-color: #ccc;">
    <form role="form" name="reserveForm" id="search" action="circulation_action.php" method="post" style="display: inline;">
...
if (isset($_SESSION['memberID'])) {
    ...
    echo '<form role="form" name="reserveHiddenForm" method="post" action="circulation_action.php"><input type="hidden" name="process" value="delete" /><input type="hidden" name="reserveID" value="" /></form>';
}
