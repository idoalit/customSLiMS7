...
if (isset($_POST['tempLoanID'])) {
    ...
    if ($add == LOAN_LIMIT_REACHED) {
        ...
        if ($sysconf['loan_limit_override']) {
            ...
            echo '<form role="form" method="post" name="overrideForm" action="'.MWB.'circulation/circulation_action.php"><input type="hidden" name="overrideID" value="'.$_POST['tempLoanID'].'" /></form>';
            echo '<script type="text/javascript">';
        ...
        echo '<html>';
        echo '<body>';
        echo '<form role="form" method="post" name="overrideForm" action="'.MWB.'circulation/circulation_action.php">';
