...
<div class="menuBoxInner quickReturnIcon">
    ...
    <div class="sub_section col-md-12">
      ...
      <form role="form" class="notAJAX" action="<?php echo MWB; ?>circulation/ajax_action.php" target="circAction" method="post" style="display: inline;">
      <?php echo __('Item ID'); ?> :
      <input type="text" name="quickReturnID" id="quickReturnID" size="30" />
      <input type="submit" value="<?php echo __('Return'); ?>" class="btn btn-primary" />
      </form>
