...
<fieldset class="menuBox">
  <div class="menuBoxInner circulationIcon">
    ...
    <div class="sub_section col-md-12">
      ...
      <form role="form" id="startCirc" action="<?php echo MWB; ?>circulation/circulation_action.php" method="post" style="display: inline;">
      ...
      echo $ajaxDD->out();
      ?>
      <input type="submit" value="<?php echo __('Start Transaction'); ?>" name="start" id="start" class="btn btn-primary" />
      </form>
    </div>
  </div>
</fieldset>
