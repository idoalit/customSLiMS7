...
if ((isset($_GET['detail']) && isset($_GET['itemID'])) || (isset($_GET['action']) && $_GET['action'] == 'detail')) {
    ...
    $form->table_attr = 'align="center" id="dataList" class="table table-hover" style="width: 100%;" cellpadding="5" cellspacing="0"';
    ...
    $datagrid->table_attr = 'align="center" id="dataList" class="table table-hover" style="width: 100%;" cellpadding="5" cellspacing="0"';
