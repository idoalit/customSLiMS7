...
if (isset($_GET['keywords']) AND $can_read) {
    ...
    if ($keywords) {
        ...
        if ($hits > 0) {
            ...
            echo '<form role="form" method="post" class="notAJAX" action="'.MWB.'bibliography/z3950.php" target="blindSubmit">';
...
<div class="menuBoxInner biblioIcon">
    ...
    <div class="sub_section col-md-12">
      <form role="form" name="search" id="search" action="<?php echo MWB; ?>bibliography/z3950.php" loadcontainer="searchResult" method="get" style="display: inline;"><?php echo __('Search'); ?> :
