...
if (!$can_read) {
  die('<div class="errorBox alert alert-danger">'.__('You are not authorized to view this section').'</div>');
}
...
if (!(class_exists('System') && class_exists('File_MARC'))) {
  die('<div class="errorBox alert alert-danger">'.__('<a href="http://pear.php.net/index.php">PEAR</a>, <a href="http://pear.php.net/package/File_MARC">File_MARC</a>
