...
if (isset($_GET['keywords']) AND $can_read) {
  ...
  if ($keywords) {
    ...
    if ($hits > 0) {
      ...
      echo '<form role="form" method="post" class="notAJAX" action="'.MWB.'bibliography/z3950sru.php" target="blindSubmit">';
      echo '<table align="center" id="dataList" class="table table-hover" cellpadding="5" cellspacing="0">';
      echo '<tr>';
...
<div class="menuBoxInner biblioIcon">
    ...
    <form role="form" name="search" id="search" action="<?php echo MWB; ?>bibliography/z3950sru.php" loadcontainer="searchResult" method="get" style="display: inline;"><?php echo __('Search'); ?> :
