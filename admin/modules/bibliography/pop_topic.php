...
<div class="popUpForm">
<form role="form" name="mainForm" action="pop_topic.php?biblioID=<?php echo $biblioID; ?>" method="post">
<div>
    <strong><?php echo __('Add Subject'); ?></strong>
    <hr />
    <form role="form" name="searchTopic" method="post" style="display: inline;">
    <?php
