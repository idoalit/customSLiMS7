...
if (isset($_GET['keywords']) && $can_read && isset($_GET['p2pserver']))  {
    ...
    if ($data['records']) {
        ...
        echo '<form role="form" method="post" class="notAJAX" action="'.MWB.'bibliography/p2p.php" target="blindSubmit">';
...
<div class="menuBoxInner biblioIcon">
    ...
    <div class="sub_section col-md-12">
      <form role="form" name="search" action="<?php echo MWB; ?>bibliography/p2p.php" loadcontainer="searchResult" id="search" method="get" style="display: inline;"><?php echo __('Search'); ?> :
