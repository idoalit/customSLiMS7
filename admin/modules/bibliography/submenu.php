...
$menu[] = array('A', __('Bibliographic List'), MWB.'bibliography/index.php', __('Show Existing Bibliographic Data'));
$menu[] = array('Z', __('Add New Bibliography'), MWB.'bibliography/index.php?action=detail', __('Add New Bibliographic Data/Catalog'));
$menu[] = array('Header', __('Items'));
$menu[] = array('A', __('Item List'), MWB.'bibliography/item.php', __('Show List of Library Items'));
$menu[] = array('Z', __('Checkout Items'), MWB.'bibliography/checkout_item.php', __('Show List of Checkout Items'));
$menu[] = array('Header', __('Copy Cataloguing'));
$menu[] = array('A', __('Z3950 SRU'), MWB.'bibliography/z3950sru.php', __('Grab Bibliographic Data from Z3950 SRU Web Services'));
$menu[] = array(__('Z3950 Service'), MWB.'bibliography/z3950.php', __('Grab Bibliographic Data from Z3950 Web Services'));
$menu[] = array('Z', __('P2P Service'), MWB.'bibliography/p2p.php', __('Grab Bibliographic Data from Other SLiMS Web Services'));
$menu[] = array('Header', __('Tools'));
$menu[] = array('A', __('Labels Printing'), MWB.'bibliography/dl_print.php', __('Print Document Labels'));
...
$menu[] = array('Z', __('Item Import'), MWB.'bibliography/item_import.php', __('Import Data to Item/Copies database from CSV file'));
