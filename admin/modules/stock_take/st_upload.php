...
<div class="menuBoxInner stockTakeIcon">
  ...
  <div class="sub_section col-md-12">
    <form role="form" name="uploadForm" class="notAJAX" method="post" enctype="multipart/form-data" action="<?php echo MWB.'stock_take/st_upload.php'; ?>" target="uploadAction" style="display: inline;">
