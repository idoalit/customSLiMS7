...
?>
    ...
    <div class="menuBoxInner stockTakeIcon">
      ...
      <?php
      if ($view != 'm') {
        echo '<form role="form" name="stockTakeForm" class="notAJAX" action="'.MWB.'stock_take/stock_take_action.php" target="stockTakeAction" method="post" style="display: inline;">
      ...
      ?>
      <form role="form" name="search" id="search" action="<?php echo MWB; ?>stock_take/current.php" method="get" style="display: inline;">
