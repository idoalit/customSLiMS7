    ...
    <fieldset class="menuBox">
      <div class="menuBoxInner reportIcon">
        ...
        <div class="sub_section col-md-12">
          <form role="form" name="printForm" action="<?php echo $_SERVER['PHP_SELF'].'?'.$_SERVER['QUERY_STRING']; ?>" target="submitPrint" id="printForm" method="get" style="display: inline;">
...
<?php
    ...
    $table->table_attr = 'align="center" id="dataList" class="table table-hover" cellpadding="3" cellspacing="0"';
