...
$menu[] = array('A', __('GMD'), MWB.'master_file/index.php', __('General Material Designation'));
...
$menu[] = array('Z', __('Location'), MWB.'master_file/location.php', __('Item Location'));
$menu[] = array('Header', __('Lookup Files'));
$menu[] = array('A', __('Place'), MWB.'master_file/place.php', __('Place Name'));
...
$menu[] = array('Z', __('Frequency'), MWB.'master_file/frequency.php', __('Frequency'));
$menu[] = array('Header', __('Tools'));
$menu[] = array('A', __('Orphaned Author'), MWB.'master_file/author.php?type=orphaned', __('Orphaned Authors'));
...
$menu[] = array('Z', __('Orphaned Place'), MWB.'master_file/place.php?type=orphaned', __('Orphaned Place'));
