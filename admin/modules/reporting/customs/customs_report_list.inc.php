...
$menu[] = array('A', __('Custom Recapitulations'), MWB.'reporting/customs/class_recap.php', __('Title and Collection recapitulation based on classification and others'));
...
$menu[] = array('Z', __('Fines Report'), MWB.'reporting/customs/fines_report.php', __('Fines Report'));
