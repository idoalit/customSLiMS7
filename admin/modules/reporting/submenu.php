...
$menu[] = array('A', __('Collection Statistic'), MWB.'reporting/index.php', __('View Library Collection Statistic'));
$menu[] = array(__('Loan Report'), MWB.'reporting/loan_report.php', __('View Library Loan Report'));
$menu[] = array('Z', __('Membership Report'), MWB.'reporting/member_report.php', __('View Membership Report'));
